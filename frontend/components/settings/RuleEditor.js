  ...
  return (
    <div className="flex flex-col gap-6 text-slate-800 dark:text-slate-100 w-full">
      ...
      <div className="flex items-center gap-3">
        <div className="p-3 bg-indigo-50 dark:bg-primary/20 text-primary dark:text-indigo-400 border border-indigo-100 dark:border-indigo-800 rounded-2xl">
          <Sliders size={24} />
        </div>
        <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col p-5 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800/85 rounded-2xl md:col-span-1 h-fit shadow-sm transition-colors duration-300">
          ...
          <form onSubmit={handleAddRule} className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              className={`mt-2 flex items-center justify-center gap-2 px-4 py-2.5 ${bg} ${hover} text-white transition rounded-xl font-bold text-xs shadow-md`}
            >
              ...
              {rules.map((rule) => (
                ...
                >
                  <div className="flex flex-col gap-1.5 max-w-[85%]">
                    ...
                    <div className="flex items-center gap-2">
                      <span className={`px-2 py-0.5 rounded-full text-[9px] font-bold ${
                        rule.rule_type === "faq" 
                          ? "bg-blue-50 dark:bg-primary/20 text-primary dark:text-blue-400 border border-blue-100 dark:border-blue-800/50"
                          : rule.rule_type === "routing"
                          ? "bg-rose-50 dark:bg-primary/20 text-primary dark:text-rose-455 border border-rose-100 dark:border-rose-800/50"
                          : "bg-purple-50 dark:bg-primary/20 text-primary dark:text-purple-400 border border-purple-100 dark:border-purple-800/50"
                      }`}>
                  ...
                  <button
                    ...
                    className="p-1.5 text-slate-400 dark:text-slate-500 hover:text-primary dark:hover:text-rose-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition"
                  >
                    <Trash2 size={15} />
                  </button>
                </div>
      ...
      {deleteConfirm.show && (
        <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl max-w-sm w-full text-slate-850 dark:text-white shadow-2xl p-6 flex flex-col items-center gap-4 text-center animate-in fade-in zoom-in-95 duration-150">
            <div className="h-12 w-12 rounded-full bg-rose-50 dark:bg-primary/20 text-primary dark:text-rose-400 border border-rose-100 dark:border-rose-800/40 flex items-center justify-center shadow-sm">
              <Trash2 size={24} />
            </div>
            <div>
            ...
            <div className="flex gap-3 w-full mt-2 font-bold">
              ...
              <button
                ...
                className="flex-1 py-2.5 bg-primary hover:bg-primary text-white transition rounded-xl text-xs shadow-md shadow-rose-500/10"
              >
                Evet, Sil
              </button>
            </div>
